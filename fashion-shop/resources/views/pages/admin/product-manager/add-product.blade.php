            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white p-6 rounded-2xl shadow-sm border space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="prod-name" placeholder="Ví dụ: Áo sơ mi lụa cao cấp"
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
                        <input id="size" type="text" placeholder="Size"
                            class="bg-gray-50 rounded-xl py-2 px-3 text-xs border focus:ring-1 focus:ring-[#bc9c75] outline-none">
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-2xl shadow-sm border">
                    ...
                    <div class="relative group rounded-2xl overflow-hidden border border-gray-100 mb-4">
                        <img id="prod-img-main" src="https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400"
                            class="w-full h-48 object-cover">
                    </div>
                    <div
                        class="border-2 border-dashed border-gray-100 rounded-2xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-gray-50">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex gap-4">
                            <div onclick="openAlbumModal()" class="relative w-24 h-24 rounded-2xl cursor-pointer group">
                                <div class="absolute inset-0 bg-gray-200 rounded-2xl translate-x-2 -translate-y-2 z-0">
                                </div>
                                <div class="absolute inset-0 bg-gray-100 rounded-2xl translate-x-1 -translate-y-1 z-10">
                                </div>
                                <div
                                    class="absolute inset-0 rounded-2xl overflow-hidden border-2 border-white shadow-md z-20">
                            ...
                            <div
                                class="w-24 h-24 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-[#bc9c75] hover:bg-[#fffbf7] transition-all group">
                                <i class="fa-solid fa-plus text-[#bc9c75] text-sm"></i>
                                <span class="text-[11px] font-semibold text-gray-400 group-hover:text-[#bc9c75]">Thêm
                                    mới</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="albumModal"
                        ...
                        <div class="bg-white w-full max-w-2xl rounded-[32px] shadow-2xl overflow-hidden">
                            ...
                            <div class="p-6 bg-gray-50 flex justify-end gap-3">
                                <button onclick="closeAlbumModal()"
                                    class="px-6 py-2.5 rounded-xl text-[14px] font-semibold text-gray-500 hover:bg-gray-200 transition-all">Đóng</button>
                                <button
                                    class="px-6 py-2.5 rounded-xl text-[14px] font-semibold bg-[#bc9c75] text-white shadow-lg shadow-[#bc9c75]/20">Thêm
                                    ảnh mới</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-6 flex justify-end gap-3">
                    <button onclick="loadPage('product-list')"
                        class="px-6 py-2 border border-gray-200 rounded-xl text-xs font-semibold text-gray-500 hover:bg-gray-50">Quay
                        lại</button>
